...
public class RestContextProvider {
    ...
    private static final RestResourceContextItem ACTIVITI_PROCESS_MODELS = new RestResourceContextItem("process-models",
                                                                                                       "http://localhost:6565");
    private static final RestResourceContextItem ACTIVITI_FORMS = new RestResourceContextItem("forms",
                                                                                              "http://localhost:6565");

    private static final RestResourceContext ACTIVITI_CONTEXT = new RestResourceContext(RestContext.ACTIVITI,
