...
public class RestResourceProcessor {
    ...
    @Bean
    public ResourceProcessor<ResourceSupport> resourceProcessor() {
        return (ResourceSupport resourceSupport) -> {
            if (!(resourceSupport instanceof Resource)) {
                return resourceSupport;
            }

            Resource<?> resource = (Resource<?>) resourceSupport;
